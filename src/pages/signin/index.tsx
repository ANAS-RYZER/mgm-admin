...
const slides = [
  {
    ...
    description:
      "Exquisite temple jewelry craftsmanship passed down through generations, featuring intricate gold work and timeless designs.",
    image:
  ...
  },
  {
    ...
    description:
      "Magnificent gold necklaces and ornamental pieces that celebrate the sacred union of tradition and beauty.",
    image:
      "https://i.pinimg.com/736x/3b/76/5c/3b765c3656080e568690a2f9c3643494.jpg",
  },
  {
    id: 3,
    title: "Royal Craftsmanship",
    description:
      "Handcrafted gold jewelry with precious stones, embodying the rich cultural legacy of South Indian artistry.",
    image:
    ...
    <div className="flex min-h-screen flex-col bg-gradient-to-b from-[#3C1124] via-[#250915] to-[#11030A] text-foreground lg:flex-row">
      <div className="relative hidden flex-1 overflow-hidden bg-gradient-to-b from-[#3C1124] via-[#250915] to-[#11030A] lg:flex">
        ...
        <div className="relative z-10 flex h-full flex-col justify-between p-12 text-primary-foreground">
          <div>
            <span className="text-sm uppercase tracking-[0.45em] text-primary-foreground/70">
              MGM Jewels
            </span>
        ...
        <div className="w-full max-w-md space-y-10 p-10 text-white">
          <div className="space-y-3 text-center lg:text-left">
            ...
            <h1 className="text-3xl font-display font-semibold text-white">
              Sign in to MGM Admin
            </h1>
            <p className="text-sm text-white/80">
              Manage operations, campaigns, and concierge experiences from one
              curated workspace.
            </p>
          </div>
          ...
          <p className="text-center text-xs text-white/60">
            Continuing confirms you accept MGM&apos;s security protocols and
            privacy guidelines.
          </p>
        </div>
      </div>
